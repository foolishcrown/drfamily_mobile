...
import 'package:dr_family_app/class/CreateSuccessDialog.dart';
...
class _MyCustomFormState extends State<MyCustomForm2> {
  ...
  File _image;
  final List<String> items = <String>['Mối quan hệ', 'Chồng', 'Vợ','Con','Ba','Mẹ'];
                                            ...
                                            Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  hintText: 'Nhập số chiều cao của bạn',
                                                ),
                                                obscureText: false,
                                                validator: (value) {
                                                  if (value.isEmpty) {
                                            ...
                                            Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  hintText: 'Nhập số cân nặng của bạn',
                                                ),
                                                obscureText: false,
                                                validator: (value) {
                                                  if (value.isEmpty) {
