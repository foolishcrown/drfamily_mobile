...
class _DoctorListState extends State<DoctorList> {
  List<Doctor> doctors = [
    ...
    Doctor(
        ...
        rate: '4.3'),
    Doctor(
        name: 'Ths-Bs.CKI Nguyễn Sơn Lâm',
        experient: "(Nội sỏi thận, Bài tiết)",
        education: 'Đh Y Phạm Ngọc Thạch',
        img: 'assets/picture/Capture3.PNG',
        fee: '400.000',
        rate: '4.5'),
    Doctor(
        name: 'Ts-Bs.CKI Nguyễn Văn Sĩ',
        experient: "(Tim mạch)",
        education: 'Đh Y Phạm Ngọc Thạch',
        img: 'assets/picture/Capture4.PNG',
        fee: '500.000',
        rate: '4.9'),
    Doctor(
        name: 'Ts-Bs.CKI Nguyễn Văn Sĩ',
