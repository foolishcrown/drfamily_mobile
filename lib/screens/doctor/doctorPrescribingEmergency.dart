...
class DoctorPrescribingEmergency extends StatefulWidget {
  @override
  _DoctorPrescribingEmergencyState createState() => _DoctorPrescribingEmergencyState();
}
// List<DonThuoc> listThuoc = [];
List<DonThuoc> listThuoc = new List();
class _DoctorPrescribingEmergencyState extends State<DoctorPrescribingEmergency> {
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              showDialog(
                                  ...
                                  builder: (_) => new AlertDialog(
                                    title: new Text("Xác Nhận"),
                                    content: new Text("Bạn có chắc là muốn xóa !"),
                                    actions: <Widget>[
                                      Row(
                                        children: [
                                          FlatButton(
